        /*Nota importante el Y de cada cuadro hace referencia a las filas de la matriz, por lo tanto al guardar una figura
         *se puede observar q se utiliza matriz[j][i] siendo i,j los valores de X y Y q se obtuvieron del vector figura*/
        var canvas;
        var ctx;        
        ...
        $(document).ready(function(){
             ...
             $('#bafle').click(function(){
                 if(sonidoActivo){
                     $(this).attr('src','../img/bafle2.png');
                     sonidoActivo = false;
                 }
                 else{
                     $(this).attr('src','../img/bafle.png');
                     sonidoActivo = true;
                 }
      ...
      function MovAbajo(){
        ...
        function principal(){
            ...
            cuadro1 = new Image();
            cuadro1.src = "../img/cuadro1.png";            
            
            cuadro2 = new Image();
            cuadro2.src = "../img/cuadro2.png";       
            
            cuadro3 = new Image();
            cuadro3.src = "../img/cuadro3.png";
            
            cuadro4 = new Image();
            cuadro4.src = "../img/cuadro4.png";
            
            cuadro5 = new Image();
            cuadro5.src = "../img/cuadro5.png";
            
            cuadro6 = new Image();
            cuadro6.src = "../img/cuadro6.png"; 
